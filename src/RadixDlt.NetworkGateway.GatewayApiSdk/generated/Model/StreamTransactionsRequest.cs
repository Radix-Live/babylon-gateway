 ...
 *
 * The version of the OpenAPI document: v1.10.5-L
...
namespace RadixDlt.NetworkGateway.GatewayApiSdk.Model
{
    ...
    public partial class StreamTransactionsRequest
    {
        ...
        /// </summary>
        /// <value>Whether the filter should require all addresses (AND) or any of them (OR) to be present in the transaction. Default - \&quot;And\&quot;.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Whether the filter should require all addresses (AND) or any of them (OR) to be present in the transaction. Default - \&quot;And\&quot;.</value>
        [DataMember(Name = "affected_global_entities_filter_type", EmitDefaultValue = true)]
        public AffectedGlobalEntitiesFilterTypeEnum? AffectedGlobalEntitiesFilterType { get; set; }
        /// <summary>
        ...
        /// <param name="affectedGlobalEntitiesFilterType">Whether the filter should require all addresses (AND) or any of them (OR) to be present in the transaction. Default - \&quot;And\&quot;. (default to AffectedGlobalEntitiesFilterTypeEnum.And).</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AffectedGlobalEntitiesFilterType: ").Append(AffectedGlobalEntitiesFilterType).Append("\n");
        ...
        public bool Equals(StreamTransactionsRequest input)
        {
            ...
            return 
                ...
                (
                    this.AffectedGlobalEntitiesFilterType == input.AffectedGlobalEntitiesFilterType ||
                    this.AffectedGlobalEntitiesFilterType.Equals(input.AffectedGlobalEntitiesFilterType)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AffectedGlobalEntitiesFilterType.GetHashCode();
