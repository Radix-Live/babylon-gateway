...
SELECT
    ...
    CASE WHEN configuration.with_receipt_costing_parameters THEN receipt_costing_parameters ELSE '{{}}'::text END AS receipt_costing_parameters,
    CASE WHEN configuration.with_receipt_fee_summary THEN receipt_fee_summary ELSE '{{}}'::text END AS receipt_fee_summary,
    CASE WHEN configuration.with_receipt_next_epoch THEN receipt_next_epoch ELSE '{{}}'::text END AS receipt_next_epoch,
    CASE WHEN configuration.with_receipt_output THEN receipt_output ELSE '{{}}'::text END AS receipt_output,
    CASE WHEN configuration.with_receipt_state_updates THEN receipt_state_updates ELSE '{{}}'::text END AS receipt_state_updates,
    CASE WHEN configuration.with_receipt_events THEN receipt_event_emitters ELSE '{{}}'::text[] END AS receipt_event_emitters,
    ...
    CASE WHEN configuration.with_balance_changes THEN balance_changes ELSE '{{}}'::text END AS balance_changes,
