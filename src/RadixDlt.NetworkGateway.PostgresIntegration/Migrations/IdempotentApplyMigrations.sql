...
BEGIN
    ...
    CREATE TABLE entity_role_assignments_owner_role_history (
        ...
        from_state_version bigint NOT NULL,
        entity_id bigint NOT NULL,
        role_assignments text NOT NULL,
...
BEGIN
    ...
    CREATE TABLE ledger_transactions (
        ...
        receipt_fee_summary text NOT NULL,
        receipt_state_updates text NOT NULL,
        receipt_costing_parameters text NOT NULL,
        receipt_fee_source text,
        receipt_fee_destination text,
        receipt_next_epoch text,
        receipt_output text,
        receipt_error_message text,
        receipt_event_emitters text[] NOT NULL,
